<template>
  <div id="container">
    <NewRegistrationDialog
      ...
      :title="dialogType === 'review' ? `Request to join Āhau from ---- ${currentNotification.from.preferredName}`:`Request to join : ${currentNotification.message.group.preferredName}`"
