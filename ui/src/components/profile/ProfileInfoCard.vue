<template>
    <div>
      <v-row cols="12" class="rounded-border">
        ...
        <ProfileInfoItem v-if="profile.type === 'person'" class="br bb" :title="'Preferred Name'" :value="profile.preferredName"/>
        <ProfileInfoItem v-if="profile.type === 'person'" class="br bb" :title="'Age'" :value="age"/>
        <ProfileInfoItem v-if="profile.type === 'person'" class="br bb" :title="'Occupation'" :value="profile.profession" />
        <ProfileInfoItem v-if="profile.type === 'person'" class="bb" :title="'City'" :value="profile.city" />
        <ProfileInfoItem v-if="profile.type === 'person'" mdCols="12" :title="'Country'" :value="profile.country" />
      </v-row>
