<template>
  <div class="wrapper">
    ...
    <v-container :fluid="true" class="white pa-0">
      ...
      <v-row>
        ...
        <v-col cols="12" class="pa-6">
          ...
          <!-- Pofile pic -->
          <v-row class="avatar-row" justify="end">
            <v-col class="avatar-box">
              <Avatar :image="profile.avatarImage" :alt="profile.preferredName" size="150" />
            </v-col>
            <!-- Edit icon -->
            <v-btn v-if="profile.canEdit" text small class="fixed-button" color="white" @click="editProfile()">
          ...
          <v-row justify="center" style="margin-top: 20px">
            <v-col cols="10">
              <v-row justify="center">
                <h1 class="primary--text title">{{ profile.legalName }}</h1>
              </v-row>
              <!-- <v-row>
            ...
            <!-- Nav Icons -->
            <v-row class="icon-bar ma-3">
              <v-col class="nav-row" to="/archive">
          ...
          <v-row>
            <v-col cols="12">
              <v-card light min-height="150px">
                <v-card-title class="subtitle-1">About</v-card-title>
                <v-card-text>
          ...
          <v-row>
            <v-col cols="12">
              <v-card light min-height="200px">
                <v-card-title class="subtitle-1">Contact</v-card-title>
                <v-card-text>
                  <p>
                    TODO: Contact fields
                  </p>
          ...
          <v-row>
            <v-col cols="6">
              <v-card min-height="200px" light class="my-3 rounded-card">
                <h4 class="col-subtitle mt-3 subtitle-1">Kaitiaki</h4>
                <v-card-text>
            ...
            <v-col cols="6">
              ...
              <v-card min-height="200px" light class="my-3 rounded-card">
                <h4 class="col-subtitle mt-3 subtitle-1">Communities</h4>
                <v-card-text>
