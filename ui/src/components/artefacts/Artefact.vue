<template>
  <v-sheet @click="toggleArtefact" style="background-color:grey">
    ...
    <div v-if="artefact.__typename === 'Audio'" :style="showArtefact ? 'height:300px': mobile ? 'height:300px' : 'height:500px'">
